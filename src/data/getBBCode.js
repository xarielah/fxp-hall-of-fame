...
export default function getBBCode(weeklyUser, weeklyThread) {
    ...
    [/FONT][FONT=tahoma][COLOR=#000000]במשך השבוע האחרון הפגנת פעילות גבוהה, השתתפות באשכולות ופעילויות. [/COLOR]הנך זוכה בלא פחות מ- [B][COLOR=#43c6db]7 ימי ווינר, [/COLOR][/B][B][COLOR=#a4de40]30 נקודות FxP[/COLOR] [COLOR=#000000]ואף תת ניק מעוצב[/COLOR][/B][B], כל הכבוד!`
            : `[SIZE=5][U][B][COLOR=#000000]לא נמצא משקיען[/COLOR][/B][/U][/SIZE]`
    }
    
    [/B][/FONT][/SIZE][IMG]https://images.weserv.nl/?url=i.imgur.com/tMcj3xu.png[/IMG][SIZE=3][FONT=tahoma]
    [/FONT][/SIZE][IMG]https://i.imagesup.co/images2/03ead3e48ea396065b11dd750c04e2a6b2ba9f78.png[/IMG]
    ${
        weeklyThread.length
            ? `[SIZE=3][FONT=tahoma][IMG]https://images.weserv.nl/?url=i.imgur.com/ThPiUoI.png[/IMG][SIZE=5][URL="${weeklyThread[2]}"][U][B][COLOR=#daa520]ללא[/COLOR][/B][/U][/URL][/SIZE][IMG]https://images.weserv.nl/?url=i.imgur.com/ThPiUoI.png[/IMG]
